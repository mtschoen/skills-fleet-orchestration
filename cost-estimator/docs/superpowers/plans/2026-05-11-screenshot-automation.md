...
- [x] **Step 1: Add screenshot-trend embed after "Trend across sessions" section**
...
- [x] **Step 2: Add screenshot-compare embed after "Comparing two windows" section**
...
- [x] **Step 3: Extend `## Files` list with new entries**
...
- [x] **Step 4: Render-check the README**
